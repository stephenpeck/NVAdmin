...
function getConfigFileName() {
	return "config_admincontrol-dev.nextventure.co.uk.inc.php";
}
...
function getDomain() {
	return "admincontrol-dev.nextventure.co.uk";
}
 ...
 */
function getWebRoot() {
	return "http://admincontrol-dev.nextventure.co.uk/";
}
function getAdminCommand() {
	return "http://admincontrol-dev.nextventure.co.uk/index.php";
}
