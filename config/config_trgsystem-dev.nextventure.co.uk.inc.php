...
function getConfigFileName() {
	return "config_trgsystem_dev.nextventure.co.uk.inc.php";
}
...
function getDomain() {
	return "trgsystem-dev.nextventure.co.uk";
}
 ...
 */
function getWebRoot() {
	return "http://trgsystem-dev.nextventure.co.uk/";
}
function getAdminCommand() {
	return "http://trgsystem-dev.nextventure.co.uk/index.php";
}
