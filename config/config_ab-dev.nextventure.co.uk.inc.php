...
function getConfigFileName() {
	return "config_ab-dev.nextventure.co.uk.inc.php";
}
...
function getDomain() {
	return "ab-dev.nextventure.co.uk";
}
 ...
 */
function getWebRoot() {
	return "http://ab-dev.nextventure.co.uk/";
}
function getAdminCommand() {
	return "http://ab-dev.nextventure.co.uk/index.php";
}
