...
function getConfigFileName() {
	return "config_trgsystem.nextventure.co.uk.inc.php";
}

// templates directory
function getTemplateDir() {
	return "/var/www/html/NV_ADMIN/templates";
}
function getCMSTemplateDir() {
	return "/var/www/html/NV_ADMIN/templates/cms/nextventure";
}
// CC
function getCSS() {
	return "NextVenture";
...
function getDomain() {
	return "trgsystem.nextventure.co.uk";
}
 ...
 */
function getWebRoot() {
	return "http://trgsystem.nextventure.co.uk/";
}
function getAdminCommand() {
	return "http://trgsystem.nextventure.co.uk/index.php";
}
...
function getSmartyRoot() {
	$smartyRoot = "/var/www/html/NV_ADMIN/libs/Smarty/";
